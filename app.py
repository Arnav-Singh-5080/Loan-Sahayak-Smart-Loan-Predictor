...
# -----------------------------------
st.set_page_config(
    page_title="LoanSahayak (लोन सहायक)",
    page_icon="🏦",
    layout="wide"
)
...
<div class="hero">
    ...
    <div class="tagline">AI-Powered Decision Intelligence for Smart Lending</div>
</div>
""", unsafe_allow_html=True)
...
The model predicts whether a loan should be approved based on the
